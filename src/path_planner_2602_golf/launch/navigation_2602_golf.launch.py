    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                'density': 10.0,                # Puntos por metro cuadrado libre
                'k_neighbors': 4,               # Conexiones por nodo (subido a 5 para más fluidez)
                'max_edge_dist': 2.0,           # Longitud máxima de las líneas
            }]
        ),
        ...
        #         'w_pos': 10.0,           # W1: Prioridad de ruta
        #         'w_smooth': 0.05,         # W2: Suavidad
        #         'w_straight': 0.5,       # W3: Evitar zig-zag
        #         'w_vel': 0.2,            # W4: Mantener velocidad
        #         'v_max': 1.0,            # Límite motor lineal
        #         'w_max': 1.0,            # Límite motor angular
        #     }]
        # ),
    ])